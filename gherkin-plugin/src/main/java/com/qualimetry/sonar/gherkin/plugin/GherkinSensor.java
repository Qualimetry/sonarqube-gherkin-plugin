...
public class GherkinSensor implements Sensor {
    ...
    private void analyzeFile(SensorContext context, FeatureParser parser,
        ...
        // Gherkin parse error (Note 78): the parser produced no document.
        // A parsed file without a Feature declaration falls through to the
        // checks, where FeatureFileRequiredCheck fires.
        if (featureFile.parseFailed()) {
